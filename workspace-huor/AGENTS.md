...
|-------|-------|-----------|
| **Huor** (you if Team Lead) | Task execution, GitHub, metrics, synthesis | #team-lead, #tasks |
| **Tuor** (you if Co-Founder) | Strategic briefings, product vision, market research | #co-founder |
| **Beren** (you if Chief of Staff) | Meta-orchestration, digests, system evaluation | #chief-of-staff |

...
**Date:** Feb 23, 2025
**Engagement:** 329 replies | 1.6K reposts | 10K likes | 4.3M views
...
> Codex and Claude Code have very little context about your business. They see code. They don't see the full picture of your business.
...
The agent runs in a tmux session with full terminal logging via a script. Here's how we launch agents:
...
I used to use codex exec or claude -p, but switched to tmux recently:
...
The Ralph Loop pulls context from memory, generates output, evaluates results, saves learnings. But most implementations run the same prompt each cycle. The distilled learnings improve future retrievals, but the prompt itself stays static.
...
*Elvis (@elvissun) — 2x dad building the modern PR stack in public: medialyst.ai*
